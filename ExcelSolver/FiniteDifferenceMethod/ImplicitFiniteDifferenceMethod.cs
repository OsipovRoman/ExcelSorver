...
{
    /// <summary>
    /// Реализует не явный вариант конечно разностной аппроксимации
    /// </summary>
    public class ImplicitFiniteDifferenceMethod : AbstractFiniteDifferenceMethod
    {
        /// <summary>
        ...
        public override double DerivativeValue(Func<double[], double> function, double[] x, int index, double h = 0.0001)
        {
            ...
            return ImplicitDerivativeValues(functionValuePlusH, functionValueMinusH, functionValue);
        }
    }
}
